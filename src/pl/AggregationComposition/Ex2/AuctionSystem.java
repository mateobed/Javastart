...
public class AuctionSystem {
    public static void main(String[] args) {
        ...
        System.out.println(auction1.title + ", " + auction1.description + ", " + auction1.price +
                "zł, sprzedający: " + auction1.seller.firstName + " " + auction1.seller.lastName);
        System.out.println(auction2.title + ", " + auction2.description + ", " + auction2.price +
                "zł, sprzedający: " + auction2.seller.firstName + " " + auction2.seller.lastName);
