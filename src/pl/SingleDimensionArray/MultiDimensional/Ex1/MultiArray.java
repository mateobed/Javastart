package pl.SingleDimensionArray.MultiDimensional.Ex1;

public class MultiArray {
    public static void main(String[] args) {
//        double [][] tab = new double [3][0];
//
...
//        tab[2] = line2;
        ...
        result = tab[0][0] + tab[1][0] + tab[2][0] + tab[2][1] + tab[2][2] + tab[1][2] + tab[0][2] + tab[0][1];
        System.out.println("Suma wszystkich elementów znajdujących się przy krawędzi tablicy: " + result);
    }
}
